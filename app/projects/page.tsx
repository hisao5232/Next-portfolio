...
/**
 * Projects ページコンポーネント
 * 重複していた定義を整理し、構文エラー（閉じタグ不足）を修正しました。
 */
      ...
      <div className="max-w-6xl mx-auto px-4 py-20">
              ...
              <div className="p-8">
                ...
                <div className="flex items-center justify-between pt-4 border-t border-slate-50">
                  <a
                    ...
                    className="flex items-center gap-2 text-xs font-black uppercase tracking-widest text-slate-900 hover:text-amber-600 transition-colors no-underline"
                  >
        ...
        <div className="reveal delay-3 mt-24 bg-slate-900 rounded-[3rem] p-12 text-center text-white">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-block bg-amber-500 text-slate-950 px-10 py-4 rounded-full font-black uppercase tracking-widest hover:bg-white hover:scale-105 transition-all no-underline"
          >
            Visit My GitHub
          </a>
        </div>
